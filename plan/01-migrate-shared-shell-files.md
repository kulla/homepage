...
- `astro-scholar-main/src/components/Header.astro` ->
  `src/components/Header.astro`
- `astro-scholar-main/src/components/Navigation.astro` ->
  `src/components/Navigation.astro`
- `astro-scholar-main/src/components/Menu.astro` -> `src/components/Menu.astro`
- `astro-scholar-main/src/components/ThemeToggle.astro` ->
  `src/components/ThemeToggle.astro`
- `astro-scholar-main/src/components/Footer.astro` ->
